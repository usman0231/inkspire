...
export default function social() {
  ...
  // Social page
  const heading = "Social Media"
  const banner_text = "Build a digital presence that inspires and engages."
  const service_type = "Unlock the Power of Social Media"
  const service_para = "At InkspireFolio, we help brands thrive in the fast-paced world of social platforms. From content creation and community management to strategic campaigns, we ensure your brand voice is consistent, engaging, and impactful. Our approach combines creativity with analytics to maximize reach, engagement, and conversions."
  const Portfolio_heading = "Social Media Showcase"
  const Portfolio_para = "Stay ahead of trends with tailored strategies and eye-catching content designed to make your brand shine across all platforms."
