...
export default function LogoDesignPage() {
  ...
  // Logo Design page
  const heading = "Logo Design"
  const banner_text = "Make your brand identity unforgettable with a logo that speaks volumes."
  const service_type = "Crafting Iconic Logos That Define Your Brand"
  const service_para = "At InkspireFolio, we specialize in designing timeless, impactful logos that embody your brand’s personality. Our creative team works closely with you to develop visuals that not only look stunning but also build recognition and trust. From minimalist designs to bold, illustrative marks, we create logos that leave a lasting first impression and connect deeply with your audience."
  const Portfolio_heading = "Logo Portfolio"
  const Portfolio_para = "Every logo we craft reflects originality and precision — ensuring your brand stands out in a crowded market. Your satisfaction is our driving force, and quality is at the heart of everything we deliver."
