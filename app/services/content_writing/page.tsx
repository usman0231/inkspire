...
export default function BookWriting() {
  ...
  // Book Writing page
  const heading = "Book Writing"
  const banner_text = "Turn your ideas into captivating words that leave an impact."
  const service_type = "Professional Writing That Brings Your Story to Life"
  const service_para = "At InkspireFolio, we offer end-to-end book writing services — from concept development to polished manuscripts. Whether it’s fiction, non-fiction, or a professional guide, our experienced writers capture your vision and shape it into engaging narratives that resonate with readers."
  const Portfolio_heading = "Book Writing Portfolio"
  const Portfolio_para = "We craft words with precision and creativity, ensuring your book leaves a lasting impression in the literary world."
